    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li>
                    <a href="<%=request.getContextPath() %>/CTRLgererReservation" data-target="#submenu-1">
                        <!--<i class="fa fa-fw fa-search"></i>-->
                        Gerer Reservation
                        <i class="fa fa-fw fa-chevron-circle-right pull-right"></i></a>
                </li>
                <li>
                    <a href="<%=request.getContextPath() %>/CTRLgererSalles" data-toggle="collapse" data-target="#submenu-2">
                        Gerer Salles
                        <i class="fa fa-fw fa-chevron-circle-right pull-right"></i>
                    </a>
                </li>
                <li>
                    <a href="<%=request.getContextPath() %>/CTRLgererEquipment.jsp?id=gererequipment" data-toggle="collapse" data-target="#submenu-3"> Gerer Equipment
                        <i class="fa fa-fw fa-chevron-circle-right pull-right"></i>
                    </a>
                </li>
            </ul>
                            ...
                            <div class="tab-pane fade in active header" id="tab1">
                                ...
                                <!--<form class="form-group" action="#">-->
                                    <!--<div class="input-group">-->
                                        <!--<input class="btn btn-lg" name="SchSallVide" id="SchSallVide" type="text" placeholder="Search for ..." required>-->
                                        <!--<button class="btn btn-info btn-lg" type="submit">Ajouter</button>-->
                                    <!--</div>-->
                                <!--</form>-->
                                <form class="form-inline text-center">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="searchslvide" placeholder="Search For ....">
                                    </div>
