				...
				<div class="row" id="main">
					<div class="col-sm-12 col-md-12 well" id="content">
						<div class="btn-pref btn-group btn-group-justified btn-group-lg"
							...
							<div class="btn-group" role="group">
								<button type="button" id="star" class="btn btn-warning"
									href="#tab2" data-toggle="tab">
									<span class="fa fa-edit fa-5x" aria-hidden="true"></span>
									<div class="hidden-xs">Annuler Reservation </div>
								</button>
							</div>
						</div>
						<div class="col-sm-12">
							...
							<div class="tab-pane fade in header" id="tab2">
									<h2 class="text-center text-info">Annuler Reservation</h2>
									<!-- Search -->
									<div id="formsearcha" class="panel panel-default"></div>
								<!-- ---------------------------------------- -->
								<div id="resSearchSallea"></div>
								<!-- ---------------------------------------- -->
								</div>
							</div>
